#
#  Be sure to run `pod spec lint Vertifi.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.license      = "ImageDownloadManager"
  ...
  s.author             = { "ImageDownloadManager" => "rchowdarys@gmail.com" }
